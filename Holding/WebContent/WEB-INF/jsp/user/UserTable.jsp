	...
	<table class="layui-table"
				...
				<thead>
					<tr>
						...
						<th lay-data="{field:'id', width:100, sort: true}">用户ID</th>
						<th lay-data="{field:'name', width:100, sort: true}">用户名</th>
						<th
							lay-data="{field:'password', width:100, sort: true, edit: 'text'}">密码</th>
						<th lay-data="{field:'weixin', edit: 'text', Width: 80}">微信</th>
						<th lay-data="{field:'phone', width:150, edit: 'text'}">联系方式</th>
						<th lay-data="{field:'status', edit: 'text', minWidth: 150}">状态</th>
						<th lay-data="{field:'score', edit: 'text', minWidth: 150}">信誉分</th>
